    ...
    def post(self,request,pk=None):
        try:
            if pk:
                ...
                # HistoricalPerformance_object.on_time_delivery_rate=vendor_detail.vendor.on_time_delivery_rate
                # HistoricalPerformance_object.quality_rating_avg=vendor_detail.vendor.quality_rating_avg
                # HistoricalPerformance_object.average_response_time=vendor_detail.vendor.average_response_time
                # HistoricalPerformance_object.fulfillment_rate=vendor_detail.vendor.fulfillment_rate
